...
//订阅
	...
	array( "type" => "open"),
       ...
       array("name" => "输入你的Feed地址",
            ...
            "type" => "text",
            "std" => "http://feed.feedsky.com/zruck"),
...
//"google自定义搜索
	...
	array(	"name" => "输入首页广告代码",
            ...
            "id" => $shortname."_adh_c",
            "type" => "textarea",
            "std" => '<a href="http://mobanbus.cn/" target="_blank"><img src="./wp-content/themes/ZruckMetro/images/ad1.jpg" alt="zruckMetro主题" /></a>'),
...
<p>设计者:<a href="http://mobanbus.cn" target="_blank">木头张</a> | 资助我开发：<a style="display:inline-block;" href="https://me.alipay.com/diesto" target="_blank"><img src="<?php bloginfo('template_directory')?>/includes/options/alipay.png" alt="资助我，人人为我，我为人人" /></a> | <a href="http://mobanbus.cn" target="_blank">查看主题更新</a></p>
<div class="rm_opts">
<form method="post">
