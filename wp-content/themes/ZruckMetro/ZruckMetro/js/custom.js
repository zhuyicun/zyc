...
$('.context_pr').hover(
	function() {
		$(this).find('.context_pr_tip').stop(true,true).fadeIn();
	},
	function() {
		$(this).find('.context_pr_tip').stop(true,true).fadeOut();
	}
);
});
...
$('.context_ne').hover(
	function() {
		$(this).find('.context_ne_tip').stop(true,true).fadeIn();
	},
	function() {
		$(this).find('.context_ne_tip').stop(true,true).fadeOut();
	}
);
});
...
$('.comment').hover(
	function() {
		$(this).find('.reply').stop(true,true).fadeIn();
	},
	function() {
		$(this).find('.reply').stop(true,true).fadeOut();
	}
);
});
...
$('.entry_box').hover(
	function() {
		$(this).find('.archive_more a').stop(true,true).fadeIn();
	},
	function() {
		$(this).find('.archive_more a').stop(true,true).fadeOut();
	}
);
});
